 ...
 */
int html_parser_cmp_tag(HTMLSTREAMPARSER *hsp, const char *p, size_t l);
 ...
 * Returns 1 for equality otherwise returns 0.
 */
int html_parser_cmp_attr(HTMLSTREAMPARSER *hsp, const char *p, size_t l);
 ...
 * Returns 1 for equality otherwise returns 0.
 */
int html_parser_cmp_val(HTMLSTREAMPARSER *hsp, const char *p, size_t l);
 ...
 * Returns 1 for equality otherwise returns 0.
 */
int html_parser_cmp_inner_text(HTMLSTREAMPARSER *hsp, const char *p, size_t l);
